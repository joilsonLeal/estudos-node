...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/node.js-parte-1$1.0.0/src/app/views/books/list/list.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("</table> <script src=\"./src/app/views/books/list/remove-book.js\"></script> ");
...
marko_template.meta = {
    id: "/node.js-parte-1$1.0.0/src/app/views/books/list/list.marko",
    tags: [
